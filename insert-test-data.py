...
with transaction.atomic():
    ...
    q1 = models.MultipleChoiceQuestion.objects.create(text_en="Q?", section=qz1)
    models.MultipleChoiceAnswer.objects.create(question=q1, text_en="A1", correct=False, explanation_en="Explanation why A1 is false")
    models.MultipleChoiceAnswer.objects.create(question=q1, text_en="A2", correct=True, explanation_en="Explanation why A2 is true")
    ...
    user1 = models.User.objects.create_superuser(email='foo@example.com', password='foobar123', name='Maija', is_supervisor=False)
    user2 = models.User.objects.create_user(email='bar@example.com', organization=org1, password='foobar123', name='Matti', is_supervisor=True)
